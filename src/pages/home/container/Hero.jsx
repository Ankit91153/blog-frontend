...
const Hero = () => {
  return (
    <section className="container mx-auto flex flex-col px-5 py-5 lg:flex-row items-center">
      <div className="mt-10 lg:w-1/2">
        ...
        Explore the latest trends in technology, programming insights, and expert guides to level up your skills.
        </p>
